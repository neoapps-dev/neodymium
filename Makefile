...
ISO = neodymium.iso
OBJS = $(BUILD)/boot/boot.o $(BUILD)/drivers/vga.o $(BUILD)/drivers/serial.o $(BUILD)/drivers/ps2.o $(BUILD)/kernel/kernel.o $(BUILD)/kernel/idt.o $(BUILD)/kernel/isr.o $(BUILD)/kernel/printf.o $(BUILD)/kernel/gdt.o $(BUILD)/kernel/pmm.o $(BUILD)/kernel/vmm.o
